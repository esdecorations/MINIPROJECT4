  ...
  return (
    <>
      <SEO 
        ...
        description="Find answers to common questions about ES Decorations event management services, catering packages, booking process, and pricing in Kottayam, Kerala."
        keywords="event planning FAQ, catering questions, wedding decoration FAQ, event management help, ES Decorations info"
        url="https://www.esdecorations.in/faq"
      />
