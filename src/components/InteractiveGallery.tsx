...
const InteractiveGallery = () => {
  ...
  if (loading) {
    return (
      <>
        <SEO 
          title="Event Gallery - Our Work Showcase"
          description="Explore our stunning portfolio of event decorations, weddings, corporate events, and celebrations."
          keywords="event gallery Kottayam, wedding photos Kerala, decoration portfolio"
          url="https://www.esdecorations.in/gallery"
        />
  ...
  return (
    <>
      <SEO 
        title="Event Gallery - Our Work Showcase"
        description="Explore our stunning portfolio of event decorations, weddings, corporate events, and celebrations. See how ES Decorations transforms ordinary spaces into extraordinary experiences in Pampady, Kottayam."
        keywords="event gallery Kottayam, wedding photos Kerala, decoration portfolio, event showcase, wedding decoration gallery, corporate event photos, catering showcase"
        url="https://www.esdecorations.in/gallery"
